...
// Exemplo: API_URL=https://back.onlyflow.com.br npm run send-promo-api
...
async function sendPromoViaAPI() {
  try {
    ...
    if (!email || !password) {
      ...
      console.log('\nPara produção:');
      console.log('  API_URL=https://back.onlyflow.com.br EMAIL=seu@email.com PASSWORD=suasenha npm run send-promo-api');
      process.exit(1);
    }
